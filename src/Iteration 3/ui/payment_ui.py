...
"}")
        ...
        self.new_customer_cb = QtWidgets.QCheckBox(payment_dialog)
        self.new_customer_cb.setGeometry(QtCore.QRect(470, 198, 125, 17))
        ...
        self.points_transaction_lbl = QtWidgets.QLabel(payment_dialog)
        self.points_transaction_lbl.setGeometry(QtCore.QRect(212, 186, 201, 16))
    ...
    def retranslateUi(self, payment_dialog):
        ...
        self.pay_with_points_lbl.setText(_translate("payment_dialog", "Not enough points"))
